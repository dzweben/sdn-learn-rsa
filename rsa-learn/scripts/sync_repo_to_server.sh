...
copy_file "$REPO_RSA/docs/LEARN_RSA_MASTERPLAN_FINAL.md" "$SERVER_RSA/docs/LEARN_RSA_MASTERPLAN_FINAL.md"
copy_file "$REPO_RSA/docs/LEARN_RSA_MASTERPLAN_FINAL.html" "$SERVER_RSA/docs/LEARN_RSA_MASTERPLAN_FINAL.html"
copy_file "$REPO_RSA/docs/LEARN_RSA_PI_WALKTHROUGH.md" "$SERVER_RSA/docs/LEARN_RSA_PI_WALKTHROUGH.md"
