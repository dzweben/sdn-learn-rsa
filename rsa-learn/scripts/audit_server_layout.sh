...
must_exist=(
  ...
  "$SERVER_RSA/scripts/LEARN_run_RSA_FINAL.sh"
  "$SERVER_RSA/scripts/LEARN_fix_nopred_fdbk_by_template.py"
  "$SERVER_RSA/scripts/LEARN_1D_AFNItiming_Full_RSA_runwise_Anticipation.sh"
  "$SERVER_RSA/scripts/LEARN_ap_Full_RSA_runwise_AFNI_noblur_Anticipation.sh"
  "$SERVER_RSA/scripts/LEARN_run_RSA_runwise_pipeline_afni_raw_Anticipation.sh"
  "$SERVER_RSA/scripts/sync_repo_to_server.sh"
  "$SERVER_RSA/scripts/audit_server_layout.sh"
  "$SERVER_RSA/docs/PIPELINE_FINAL_CANONICAL.md"
  "$SERVER_RSA/docs/README.md"
  "$SERVER_RSA/docs/RUN_STATUS_AND_DATA_REQUIREMENTS.md"
  "$SERVER_RSA/docs/PROJECT_SOUL_GUIDELINES.md"
  "$SERVER_RSA/docs/PROJECT_SOUL_INTERNAL.md"
  "$SERVER_RSA/docs/DECISION_LOG.md"
  "$SERVER_RSA/docs/REPO_SERVER_OPERATING_MODEL.md"
  "$SERVER_RSA/docs/NEXT_AGENT_UNDERGRAD_PIPELINE_PREP.md"
  "$SERVER_RSA/logs/README.md"
  "$SERVER_RSA/notes/README.md"
...
sidecar_list=$(
  {
    ...
    find "$SERVER_RSA/notes" -maxdepth 2 -type f -name '._*' 2>/dev/null
  } | sed '/^$/d'
)
