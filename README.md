...
| # | Analysis | Result | FDR |
|---|----------|--------|-----|
| 1 | **Model Alignment RSA** | Social anxiety moderates how rostral-ACC peer representations change across runs: a crossover in which alignment increases at higher social anxiety and declines at lower social anxiety (both simple slopes significant; no group-level run effect). SA by run interaction, b = +0.032, t = +3.62, p<sub>joint</sub> = .0007; simple slopes -.163 (p = .002) at -1 SD and +.108 (p = .042) at +1 SD | **q = .025** |
